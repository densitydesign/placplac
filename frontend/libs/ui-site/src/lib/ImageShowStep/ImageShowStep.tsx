...
import styles from './ImageShowStep.module.css';
...
export const ImageShowStep = (props: ImageShowProps) => {
  ...
  return (
    <div className={styles.container}>
      ...
      {description && (
        <div className={classnames(styles.container_child, styles.description)}>
          <span>
